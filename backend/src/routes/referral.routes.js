...
import { isSenior } from "../middlewares/role.middleware.js";

const router=Router();

router.post("/request",verifyToken,requestReferral);
router.put("/approve/:id", authMiddleware, isSenior, approveReferral);
router.put("/reject/:id", authMiddleware, isSenior, rejectReferral);
